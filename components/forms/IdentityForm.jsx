...
export default function IdentificationForm() {
  ...
  const identificationTypes = ['Birth Certificate', 'Passport', 'Driver\'s License', 'National ID'];
        ...
        <div className="form-group">
          ...
          <div className="file-upload-wrapper">
            ...
            <label htmlFor="documentUpload" className="file-upload-label">
              ...
              <span>{formState.document ? formState.document.name : 'Click to upload or drag and drop'}</span>
              <span className="file-format">SVG, PNG, JPG or GIF (max. 800x400px)</span>
            </label>
          </div>
        </div>
      </form>
